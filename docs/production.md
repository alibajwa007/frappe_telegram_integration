...
Though you can run your telegram-bot-server in polling mode, it is recommended to run them in webhook mode in production. `frappe_telegram_integration` comes with utility commands to easily add webhook location-blocks to your bench-nginx.conf.
