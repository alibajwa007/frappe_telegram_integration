...
class TelegramChatView {
	...
	async loadChatList() {
		const r = await frappe.xcall(
			"frappe_telegram_integration.frappe_telegram_integration.page.telegram_chat_view.load_chat_rooms", {
	...
	async loadChatMessages() {
		const r = await frappe.xcall(
			"frappe_telegram_integration.frappe_telegram_integration.page.telegram_chat_view.load_chat_messages", {
