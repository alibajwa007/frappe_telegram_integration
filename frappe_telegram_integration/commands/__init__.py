...
from frappe_telegram_integration.bot import start_polling, start_webhook
from frappe_telegram_integration.utils.supervisor import add_supervisor_entry, remove_supervisor_entry
...
def nginx_add(context, telegram_bot, webhook_port=None, webhook_url=None, nginx_path=None):
    ...
    """
    from frappe_telegram_integration.utils.nginx import add_nginx_config
...
def nginx_remove(context, telegram_bot):
    ...
    """
    from frappe_telegram_integration.utils.nginx import remove_nginx_config
